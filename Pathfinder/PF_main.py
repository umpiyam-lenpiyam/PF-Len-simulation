...
from PF_calculate_log_CR import *
from PF_calculate_log_CR2 import *
from PF_calculate_log_TI import *
from PF_calculate_log_TI2 import *
...
def run_sim(label, ring, level, directory):
    ...
    return PF_cal_damage_TI(plot_graph, ring, level, time, print_option, directory)
def run_sim2(label, ring, level, directory):
    if compare == 1: print(f'{label} ---------------------')
    return PF_cal_damage_TI2(plot_graph, ring, level, time, print_option, directory)
